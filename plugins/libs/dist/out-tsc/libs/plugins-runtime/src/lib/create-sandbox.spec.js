...
describe('createSandbox', () => {
    ...
    it('should add timeouts to the plugin and clean them on clearTimeout', () => {
        const sandbox = createSandbox(mockPlugin);
        const handler = vi.fn();
        const timeoutId = sandbox.compartment.globalThis['setTimeout'](handler, 1000);
    ...
    it('should ensure fetch requests omit credentials and return a harden response', () => __awaiter(void 0, void 0, void 0, function* () {
        const mockResponse = {
            ok: true,
            status: 200,
            statusText: 'OK',
        ...
        yield sandbox.compartment.globalThis['fetch']('https://example.com/api', {
            method: 'GET',
            credentials: 'include',
            headers: {
        ...
        expect(ses.safeReturn).toHaveBeenCalledWith(expect.objectContaining({
            ok: true,
            status: 200,
            statusText: 'OK',
            url: 'https://example.com/api',
    ...
    it('should prevent using the api after closing the plugin', () => __awaiter(void 0, void 0, void 0, function* () {
        const sandbox = createSandbox(mockPlugin);
        expect(Object.keys(sandbox.compartment.globalThis).filter((it) => !!it).length).toBeGreaterThan(0);
        sandbox.cleanGlobalThis();
        expect(Object.keys(sandbox.compartment.globalThis).filter((it) => !!it).length).toBe(0);
    }));
...
//# sourceMappingURL=create-sandbox.spec.js.map